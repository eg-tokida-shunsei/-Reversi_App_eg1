...
//エラーパターン１
// $field[2][1] = $field[6][1] = $field[6][2] = $field[7][3] = $field[5][3] = -1;
// $field[3][1] = $field[4][1] = $field[5][2] = $field[3][2] = $field[4][2] = $field[3][3] = $field[4][3] = $field[6][3] = 1;
...
//角で止めてる処理だけじゃなくて、処理の順番的に一つ前の時に石をひっくり返せてしまう処理になっている
